        ...
        match self.state {
            ...
            | State::LastAck => {
                ...
                let device_limit = {
                    ...
                    // As is the case with the MTU, the maximum size for the buffer does not
                    // include the Ethernet and IP headers.
                    .map(|buf_size| buf_size.get() - ip_repr.header_len() - TCP_HEADER_LEN)
